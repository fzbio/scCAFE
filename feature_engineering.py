...
if __name__ == '__main__':
    ...
    create_kmer_input_file(
        'external_annotations/mm10.sizes',
        'data/graph_features/mouse/mm10.fa',
        'data/graph_features/mouse/mm10.100kb.kmer.csv',
        ['chr' + str(i) for i in range(1, 20)],
        100000
    )
    create_motif_input_file(
        ...
        'data/graph_features/mouse/CTCF_mm10.100kb.input.csv',
        ['chr' + str(i) for i in range(1, 20)], 100000
    )

    create_kmer_input_file(
        'external_annotations/hg19.sizes',
        'data/graph_features/human/hg19.fa',
        'data/graph_features/human/hg19.100kb.kmer.csv',
        ['chr' + str(i) for i in range(1, 23)],
        100000
    )
    create_motif_input_file(
        'external_annotations/hg19.sizes',
        'data/graph_features/human/CTCF_hg19.bed',
        'data/graph_features/human/CTCF_hg19.100kb.input.csv',
        ['chr' + str(i) for i in range(1, 23)], 100000
    )
